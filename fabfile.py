...
env.PROJECT_NAME = "the-steven-manual"
...
def deploy_code():
    ...
    run_ve("heroku run project/manage.py syncdb --settings=envs.live")
    run_ve("heroku run project/manage.py migrate --settings=envs.live")
