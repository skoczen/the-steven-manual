...
class GutterBumperOptions(admin.ModelAdmin):
    list_display = ("date", "sleep_hrs","work_hrs","alone_hrs","friend_hrs","relationship_hrs","public_hours","off","worked_out","mediated","number_of_beers","presence","happiness","creativity","morning_mood")
    list_filter = ("date",)
