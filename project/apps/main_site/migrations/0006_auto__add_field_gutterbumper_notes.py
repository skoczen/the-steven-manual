...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.notes'
        db.add_column('main_site_gutterbumper', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.notes'
        db.delete_column('main_site_gutterbumper', 'notes')
