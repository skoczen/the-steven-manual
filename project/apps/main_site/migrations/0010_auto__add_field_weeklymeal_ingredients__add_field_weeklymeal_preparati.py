...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeeklyMeal.ingredients'
        db.add_column('main_site_weeklymeal', 'ingredients',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WeeklyMeal.preparation'
        db.add_column('main_site_weeklymeal', 'preparation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeeklyMeal.ingredients'
        db.delete_column('main_site_weeklymeal', 'ingredients')

        # Deleting field 'WeeklyMeal.preparation'
        db.delete_column('main_site_weeklymeal', 'preparation')
