...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.travelling_or_out_of_routine'
        db.add_column('main_site_gutterbumper', 'travelling_or_out_of_routine',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.travelling_or_out_of_routine'
        db.delete_column('main_site_gutterbumper', 'travelling_or_out_of_routine')
