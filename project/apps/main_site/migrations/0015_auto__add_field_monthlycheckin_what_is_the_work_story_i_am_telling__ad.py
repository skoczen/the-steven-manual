...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonthlyCheckin.what_is_the_work_story_i_am_telling'
        db.add_column('main_site_monthlycheckin', 'what_is_the_work_story_i_am_telling',
    ...
    def backwards(self, orm):
        # Deleting field 'MonthlyCheckin.what_is_the_work_story_i_am_telling'
        db.delete_column('main_site_monthlycheckin', 'what_is_the_work_story_i_am_telling')
    ...
    models = {
        ...
        'main_site.monthlycheckin': {
            ...
            'updated_at': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'what_is_the_identity_i_am_telling': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'what_is_the_relationship_i_am_telling': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
