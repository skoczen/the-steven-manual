...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_site_datasensitivity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('main_site', ['DataSensitivity'])

        # Adding field 'GutterBumper.updated_at'
        db.add_column('main_site_gutterbumper', 'updated_at',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2012, 8, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DataSensitivity'
        db.delete_table('main_site_datasensitivity')

        # Deleting field 'GutterBumper.updated_at'
        db.delete_column('main_site_gutterbumper', 'updated_at')
