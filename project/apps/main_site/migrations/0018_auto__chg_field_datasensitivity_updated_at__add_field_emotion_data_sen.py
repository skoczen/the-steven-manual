...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataSensitivity.updated_at'
        db.alter_column('main_site_datasensitivity', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'Emotion.data_sensitivity'
        db.add_column('main_site_emotion', 'data_sensitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_site.DataSensitivity'], null=True),
                      keep_default=False)


        # Changing field 'Emotion.updated_at'
        db.alter_column('main_site_emotion', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'Value.data_sensitivity'
        db.add_column('main_site_value', 'data_sensitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_site.DataSensitivity'], null=True),
                      keep_default=False)


        # Changing field 'Value.updated_at'
        db.alter_column('main_site_value', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'GutterBumper.data_sensitivity'
        db.add_column('main_site_gutterbumper', 'data_sensitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_site.DataSensitivity'], null=True),
                      keep_default=False)


        # Changing field 'GutterBumper.updated_at'
        db.alter_column('main_site_gutterbumper', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'MonthlyCheckin.data_sensitivity'
        db.add_column('main_site_monthlycheckin', 'data_sensitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_site.DataSensitivity'], null=True),
                      keep_default=False)


        # Changing field 'MonthlyCheckin.updated_at'
        db.alter_column('main_site_monthlycheckin', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'WeeklyMeal.data_sensitivity'
        db.add_column('main_site_weeklymeal', 'data_sensitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_site.DataSensitivity'], null=True),
                      keep_default=False)


        # Changing field 'WeeklyMeal.updated_at'
        db.alter_column('main_site_weeklymeal', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'DataSensitivity.updated_at'
        db.alter_column('main_site_datasensitivity', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'Emotion.data_sensitivity'
        db.delete_column('main_site_emotion', 'data_sensitivity_id')


        # Changing field 'Emotion.updated_at'
        db.alter_column('main_site_emotion', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'Value.data_sensitivity'
        db.delete_column('main_site_value', 'data_sensitivity_id')


        # Changing field 'Value.updated_at'
        db.alter_column('main_site_value', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'GutterBumper.data_sensitivity'
        db.delete_column('main_site_gutterbumper', 'data_sensitivity_id')


        # Changing field 'GutterBumper.updated_at'
        db.alter_column('main_site_gutterbumper', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'MonthlyCheckin.data_sensitivity'
        db.delete_column('main_site_monthlycheckin', 'data_sensitivity_id')


        # Changing field 'MonthlyCheckin.updated_at'
        db.alter_column('main_site_monthlycheckin', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'WeeklyMeal.data_sensitivity'
        db.delete_column('main_site_weeklymeal', 'data_sensitivity_id')


        # Changing field 'WeeklyMeal.updated_at'
        db.alter_column('main_site_weeklymeal', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        'main_site.emotion': {
            ...
            'data_sensitivity': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['main_site.DataSensitivity']", 'null': 'True'}),
