...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.woke_up_at'
        db.add_column('main_site_gutterbumper', 'woke_up_at',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 8, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'GutterBumper.fell_asleep_at'
        db.add_column('main_site_gutterbumper', 'fell_asleep_at',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 8, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'GutterBumper.inbox_zero'
        db.add_column('main_site_gutterbumper', 'inbox_zero',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.woke_up_at'
        db.delete_column('main_site_gutterbumper', 'woke_up_at')

        # Deleting field 'GutterBumper.fell_asleep_at'
        db.delete_column('main_site_gutterbumper', 'fell_asleep_at')

        # Deleting field 'GutterBumper.inbox_zero'
        db.delete_column('main_site_gutterbumper', 'inbox_zero')
    ...
    models = {
        ...
        'main_site.gutterbumper': {
            ...
            'fell_asleep_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'woke_up_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)'}),
