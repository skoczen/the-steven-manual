...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GutterBumper.number_of_beers'
        db.rename_column('main_site_gutterbumper', 'number_of_beers', 'number_of_sleep_beers')
        # db.delete_column('main_site_gutterbumper', 'number_of_beers')

        # # Adding field 'GutterBumper.number_of_sleep_beers'
        # db.add_column('main_site_gutterbumper', 'number_of_sleep_beers',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # Adding field 'GutterBumper.number_of_fun_beers'
        db.add_column('main_site_gutterbumper', 'number_of_fun_beers',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GutterBumper.number_of_beers'
        db.rename_column('main_site_gutterbumper', 'number_of_sleep_beers', 'number_of_beers')

        db.add_column('main_site_gutterbumper', 'number_of_beers',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GutterBumper.number_of_sleep_beers'
        # db.delete_column('main_site_gutterbumper', 'number_of_sleep_beers')

        raise Exception("Losing fun beer data!")
        
        # Deleting field 'GutterBumper.number_of_fun_beers'
        db.delete_column('main_site_gutterbumper', 'number_of_fun_beers')
