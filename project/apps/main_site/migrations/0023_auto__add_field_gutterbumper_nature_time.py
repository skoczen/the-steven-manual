...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.nature_time'
        db.add_column('main_site_gutterbumper', 'nature_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.nature_time'
        db.delete_column('main_site_gutterbumper', 'nature_time')
