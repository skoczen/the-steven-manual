...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emotion.slug'
        db.add_column('main_site_emotion', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=210, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emotion.slug'
        db.delete_column('main_site_emotion', 'slug')
