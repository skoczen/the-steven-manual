...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GutterBumper.weight'
        db.add_column('main_site_gutterbumper', 'weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GutterBumper.body_fat_percent'
        db.add_column('main_site_gutterbumper', 'body_fat_percent',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GutterBumper.weight'
        db.delete_column('main_site_gutterbumper', 'weight')

        # Deleting field 'GutterBumper.body_fat_percent'
        db.delete_column('main_site_gutterbumper', 'body_fat_percent')
    ...
    models = {
        ...
        'main_site.gutterbumper': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 22, 0, 0)'}),
        ...
        'main_site.monthlycheckin': {
            ...
            'month_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 22, 0, 0)'}),
